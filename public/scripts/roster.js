...
var getTDList=function(message){
	...
	//console.log(JSON.parse(url_get));
		...
		xhrGet(url_get,function(data){
			...
			var defaultOutput="<tr><th id='docId2'><input readonly value='"+teamSelected+"_"+yearSelected+String(monthSelected)+"'></input></th></tr><tr name='JSONHeader'class='headerTable' ><td class='content checkBox'><input type='checkbox' name='masterBox' id='checkAll' onclick='toggleCheckBox(this,\"simple\")'></td>	<td class='content' class='headerTable' >Date</td><td class='content' class='headerTable' >Day</td><td class='content' class='headerTable' >Morning</td><td class='content' class='headerTable' >General</td><td class='content' class='headerTable' >Evening</td><td class='content'class='headerTable'>MHC</td><td class='content' class='headerTable'>Oncall</td><td class='content' class='headerTable' >Additional</td><td class='content' class='headerTable'>Leave Plans</td><td class='content' class='headerTable' >AU Holiday</td><td class='content' class='headerTable' >IN Holiday</td></tr>";
...
var toggleCheckBox = function(node,tow){
	if (tow==='week'){
		var elementsCheck=document.getElementsByName('checkBoxWeekInput');
	}else{
...
var deleteRoster = function () {
	var out_status=confirm("Press OK to delete the entire roster, cancel to abort this operation");
	if (out_status===false){
		return;
	}
...
var listByWeek = function() {
	...
	var defaultWeekRosterOutput="<tr><th id='docId2'><input readonly value='"+rosterHeader[0]+"_"+rosterHeader[1]+"'></input></th></tr><tr name='JSONHeader'class='headerTable' ><td class='content checkBox'><input type='checkbox' name='masterBox' id='checkAll' onclick='toggleCheckBox(this,\"week\")'></td>	<td class='content' class='headerTable' >From Date</td><td class='content' class='headerTable' >From Day</td><td class='content' class='headerTable' >To Date</td><td class='content' class='headerTable' >To Day</td><td class='content' class='headerTable' >Morning</td><td class='content' class='headerTable' >General</td><td class='content' class='headerTable' >Evening</td><td class='content'class='headerTable'>MHC</td><td class='content' class='headerTable'>Oncall</td><td class='content' class='headerTable' >Additional</td><td class='content' class='headerTable'>Leave Plans</td><td class='content' class='headerTable' >AU Holiday</td><td class='content' class='headerTable' >IN Holiday</td></tr>";	
